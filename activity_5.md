...
for i in range(1,5):
    phi[i-1] = (np.pi/2)+((i-1)*5*np.pi)/(200)
    theta[i-1] = ((i-1)*10*np.pi)/100
...
plt.show()
plt.savefig('501.png', dpi = 400, bbox_inches='tight')
```
...
```
```python
fn(1e-8,1e-8,1e-8,-1e-8,-81639511514.9797,15794743884.4086,- 1478428.8543945)
fn(1e-8,1e-8,-1e-8,-1e-8, -81620731537.6655,15797649140.5877,- 1761860.08009779)
fn(1e-8,-1e-8,1e-8,-1e-8,-81659172695.4684,15791690229.3591, - 1182348.80156332)
fn(1e-8,-1e-8,-1e-8,-1e-8,-81640415723.1239, 15794598600.1629, - 1465885.44853574)
```
